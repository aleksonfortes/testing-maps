      ...
      <Dialog.Portal forceMount>
        ...
        <Dialog.Content asChild forceMount>
          <motion.div
            ...
            className="fixed inset-0 z-[500] flex items-center justify-center p-4 md:p-8 lg:p-12 pointer-events-none"
          >
            <div className="pointer-events-auto glass border border-white/10 rounded-[2.5rem] island-shadow w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh] shadow-2xl">
              <header className="p-8 border-b border-border flex justify-between items-center bg-secondary/20">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <Dialog.Title className="text-xl font-bold tracking-tight">Markdown Import</Dialog.Title>
