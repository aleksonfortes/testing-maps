 ...
 */
export const TESTING_MAP_HEADER = `<!-- Testing Map | Generated by testingmaps.com | Import this file to visualize -->\n\n`;
...
export function generateMarkdown(
  ...
  return options?.includeHeader ? TESTING_MAP_HEADER + result : result;
}
